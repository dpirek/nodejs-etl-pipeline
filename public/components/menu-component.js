...
const TAG_NAME = 'menu-component';

const svgIcons = `<svg xmlns="http://www.w3.org/2000/svg" class="d-none">
...
class MenuComponent extends BaseEelement {
  constructor(props) {
    super({
      useShadowRoot: false,
      ...props
  ...
  menuItems = [
    { name: 'DAGs', id: 'dags' , icon: 'house-fill' },
    { name: 'Pipelines', id: 'pipelines', icon: 'file-earmark-text' },
    { name: 'Nodes', id: 'nodes', icon: 'file-earmark-text' },
  ];
...
customElements.define(TAG_NAME, MenuComponent);
